...
from TogepiRobot.modules import ALL_MODULES
from TogepiRobot.modules.helper_funcs.chat_status import is_user_admin
from TogepiRobot.modules.helper_funcs.misc import paginate_modules
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("TogepiRobot.modules." + module_name)
            ...
            query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="Go Back", callback_data="help_back"),
                      InlineKeyboardButton(text="Go Home", callback_data="Togepi_back")]]
                ),
            )
...
def Togepi_data_callback(update, context):
    query = update.callback_query
    if query.data == "Togepi_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Back", callback_data="Togepi_back")
                 ]
                ]
            ),
        )
    elif query.data == "Togepi_back":
        query.message.edit_text(
                PM_START_TEXT,
                reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.MARKDOWN,
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 2140792236 and DONATION_LINK:
            update.effective_message.reply_text(
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}","[Togepi IPIN IS BACK](https://telegra.ph/file/10139851d5bf597ce8c25.jpg)", parse_mode=ParseMode.MARKDOWN) 
        except Unauthorized:
            LOGGER.warning(
    ...
    data_callback_handler = CallbackQueryHandler(Togepi_data_callback, pattern=r"Togepi_")
