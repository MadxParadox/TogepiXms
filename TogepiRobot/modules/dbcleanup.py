...
import TogepiRobot.modules.sql.global_bans_sql as gban_sql
import TogepiRobot.modules.sql.users_sql as user_sql
from TogepiRobot import DEV_USERS, OWNER_ID, dispatcher
