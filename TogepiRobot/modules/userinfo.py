...
from TogepiRobot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from TogepiRobot.__main__ import STATS, TOKEN, USER_INFO
import TogepiRobot.modules.sql.userinfo_sql as sql
from TogepiRobot.modules.disable import DisableAbleCommandHandler
from TogepiRobot.modules.sql.global_bans_sql import is_user_gbanned
from TogepiRobot.modules.sql.afk_sql import is_afk, check_afk_status
from TogepiRobot.modules.sql.users_sql import get_user_num_chats
from TogepiRobot.modules.helper_funcs.chat_status import sudo_plus
from TogepiRobot.modules.helper_funcs.extraction import extract_user
from TogepiRobot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [                  
                       ...
                       InlineKeyboardButton(
                             text="Updates",
                             url="https://t.me/TogepiIpinUpdates")
                     ] 
                ]
            ),
        )
