...
from TogepiRobot import OWNER_ID, SUPPORT_CHAT
from TogepiRobot.events import register
from TogepiRobot import telethn
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./TogepiRobot/resources/LOGOS/*")
