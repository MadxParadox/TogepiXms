#this good nsfw module only created for @TogepitpiRobot and thanks to @Everythingsuckz, all suckz removed by @Rimbahuns
import os
import html
import nekos
import requests
...
from TogepiRobot import dispatcher, updater
import TogepiRobot.modules.sql.nsfw_sql as sql
...
__help__ = """
Module credits: [TogepitpiRobot](https://github.com/Soedirmand/TogepiRobot/edit/Togepi/TogepiRobot/modules/nsfw.py) ,
