...
from TogepiRobot import BOT_NAME

# By @TogepitpiRobot
from TogepiRobot.resources.IMGEDITOR.edit_1 import (  # pylint:disable=import-error
    black_white,
    box_blur,
    bright,
    g_blur,
...
from TogepiRobot.resources.IMGEDITOR.edit_2 import (  # pylint:disable=import-error
    cartoon,
    circle_with_bg,
    circle_without_bg,
    contrast,
...
from TogepiRobot.resources.IMGEDITOR.edit_3 import (  # pylint:disable=import-error
    black_border,
    blue_border,
    green_border,
    red_border,
)
from TogepiRobot.resources.IMGEDITOR.edit_4 import (  # pylint:disable=import-error
    inverted,
    removebg_plain,
    removebg_sticker,
    removebg_white,
...
from TogepiRobot.resources.IMGEDITOR.edit_5 import (  # pylint:disable=import-error
    normalglitch_1,
    normalglitch_2,
    normalglitch_3,
    normalglitch_4,
...
__mod_name__ = "Editor"
__help__ = """
@TogepitpiRobot have some advanced image editing tools inbuilt
