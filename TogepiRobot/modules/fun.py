...
import TogepiRobot.modules.fun_strings as fun
from TogepiRobot import DEMONS, DRAGONS, dispatcher
from TogepiRobot.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
